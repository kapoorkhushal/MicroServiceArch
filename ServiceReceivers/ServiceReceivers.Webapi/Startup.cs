...
using ServiceReceivers.Application.Extensions;
...
using ServiceReceivers.Infrastructure.Registry;
using ServiceReceivers.Webapi.ServiceDiscovery;
using System;
using System.Net.Http;

namespace ServiceReceivers.Webapi
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddScoped<IGetServiceAmountDataService, GetServiceAmountDataService>();
